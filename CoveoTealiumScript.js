      ...
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.loader_cb = function () {
          ...
          if (coveo_ec_event_type) {
              ...
              } else if(!!u.data.coveo_searchuid || (!!window.utag_data && !!window.utag_data.coveosearchuid)){
                let id = !!u.data.coveo_searchuid ? u.data.coveo_searchuid : window.utag_data.coveosearchuid;
